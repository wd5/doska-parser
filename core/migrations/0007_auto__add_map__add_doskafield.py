...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_map', (
            ...
            ('imported_adv_class', self.gf('django.db.models.fields.TextField')()),
            ('doska_field_name', self.gf('django.db.models.fields.TextField')()),
            ('imported_field_name', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('core', ['Map'])

        # Adding model 'DoskaField'
        db.create_table('core_doskafield', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('group_name', self.gf('django.db.models.fields.TextField')()),
            ('field_name', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('core', ['DoskaField'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'DoskaField'
        db.delete_table('core_doskafield')
    ...
    models = {
        ...
        'core.map': {
            ...
            'doska_field_name': ('django.db.models.fields.TextField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
