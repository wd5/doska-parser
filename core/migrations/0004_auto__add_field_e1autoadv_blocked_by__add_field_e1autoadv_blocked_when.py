...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('core_e1autoadv', 'blocked_by', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True, blank=True), keep_default=False)

        # Adding field 'E1AutoAdv.blocked_when'
        db.add_column('core_e1autoadv', 'blocked_when', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'E1AutoAdv.blocked_when'
        db.delete_column('core_e1autoadv', 'blocked_when')
    ...
    models = {
        ...
        'core.e1autoadv': {
            ...
            'blocked_by': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['auth.User']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
