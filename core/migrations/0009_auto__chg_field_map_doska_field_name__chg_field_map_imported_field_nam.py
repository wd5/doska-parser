...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_map', 'doska_field_name', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Removing index on 'Map', fields ['doska_field_name']
#        db.delete_index('core_map', ['doska_field_name_id'])

        # Changing field 'Map.imported_field_name'
        db.alter_column('core_map', 'imported_field_name', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'Map.imported_adv_class'
        db.alter_column('core_map', 'imported_adv_class', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'DoskaField.field_name'
        db.alter_column('core_doskafield', 'field_name', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'DoskaField.group_name'
        db.alter_column('core_doskafield', 'group_name', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Map.imported_field_name'
        db.alter_column('core_map', 'imported_field_name', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Map.imported_adv_class'
        db.alter_column('core_map', 'imported_adv_class', self.gf('django.db.models.fields.TextField')())

        # Changing field 'DoskaField.field_name'
        db.alter_column('core_doskafield', 'field_name', self.gf('django.db.models.fields.TextField')())

        # Changing field 'DoskaField.group_name'
        db.alter_column('core_doskafield', 'group_name', self.gf('django.db.models.fields.TextField')())
