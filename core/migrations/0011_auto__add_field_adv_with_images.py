...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Adv.with_images'
        db.add_column('core_adv', 'with_images', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Adv.with_images'
        db.delete_column('core_adv', 'with_images')
